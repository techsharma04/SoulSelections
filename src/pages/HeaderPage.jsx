        ...
        <div className="header">
            ...
            <div className="logo">
                <Link to="/" className="link_text">
                    <span className="logo-text">Soul Selections</span>
                </Link>
            </div>
            <div className="login-cart">
                {loginState ? (
                    <ul className="dropdown-menu">
                        <li>
                            <Link to="/myaccount" className="login-click">
                    ...
                    <ul className="dropdown-menu">
                        <li>
                            <Link to="/register" className="login-click">
                ...
                <div className="full-cart">
                    <div className="cart-total">
                        <div className="mycart">
                            <small className="small-text">My Cart</small>
                        </div>
                        <div className="total">
                            <small className="small-text">$ {totalAmount.toFixed(2)}</small>
                        </div>
                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    {cart.map((items) => (
                                                        <tr className="wishRow" key={items.id}>
                                                            ...
                                                            <td className="align-center">
                                                                <small>
                                                                    $ {items.price * items.itemQuantity}
                                                                </small>
                                                            </td>
                                                        </tr>
                                                    ))}
